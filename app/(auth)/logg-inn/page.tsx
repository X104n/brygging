        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-zinc-100 overflow-hidden">
            <div className="bg-amber-800 px-6 py-5">
              ...
              <h1 className="text-xl font-bold text-white">Logg inn</h1>
              <p className="text-amber-200/70 text-sm mt-0.5">Velkommen tilbake til bryggeskjema</p>
            </div>
          ...
          <p className="text-sm text-center text-zinc-500 mt-5">
            Ikke bruker ennå?{' '}
            <Link href="/registrer" className="text-amber-700 hover:text-amber-900 font-semibold hover:underline transition-colors">
